...
function getTileClassName(type: TileType) {
  const baseClassName =
    "relative aspect-square w-[36px] overflow-hidden rounded-[14px] border border-[rgba(93,70,41,0.1)] bg-[#f5ecdd] shadow-[0_3px_8px_rgba(83,61,32,0.08)] max-sm:w-[30px]";
  ...
  return (
    <section className="bg-[rgba(255,252,247,0.93)] shadow-[0_14px_38px_rgba(85,61,32,0.08)] p-4 max-sm:p-3 border border-[rgba(108,80,43,0.14)] rounded-[28px] max-sm:rounded-[22px] min-w-0">
      <div className="flex justify-between items-start gap-3">
        <div>
          <h2 className="text-[#173946] text-[1.2rem]">Resort view</h2>
      ...
      {map ? (
        <div className="mt-2.5 pb-1 overflow-x-auto">
          <div
            className="gap-[0.14rem] max-sm:gap-[0.12rem] grid bg-[linear-gradient(180deg,rgba(255,251,243,0.96),rgba(247,238,224,0.96))] shadow-[inset_0_0_0_1px_rgba(109,82,45,0.08)] p-[0.16rem] max-sm:p-[0.12rem] rounded-[16px] min-w-max"
            style={{
